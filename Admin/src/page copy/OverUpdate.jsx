...
import { deletePlayer, fetchAllBallByBall, fetchAllMatch, fetchAllMatchTeamPlayers, fetchAllPlayer, updateBallByBall, updatePlayer } from '../service/API'
...
const OverUpdate = () => {
    ...
    const postData = (e) => {
        ...
        if (name === "ball_action") {
            ...
            if (value === "RUN") {
                ...
                setInputData({ ...inputData, ball_action: value, extra_run: 0, over_number: overCounter, ball_number: ballCounter });
            } else if (value === "EXTRA") {
                setDisplayWicketType(false)
                setDisplayWicketTakenBy(false)
                ...
                setInputData({ ...inputData, ball_action: value, over_number: overCounter, ball_number: ballCounter })
            } else if (value === "DOT") {
                setDisplayWicketType(false)
                setDisplayWicketTakenBy(false)
                setDisplayRunForStricker(false)
                ...
                setInputData({ ...inputData, ball_action: value, is_wicket: true, over_number: overCounter, ball_number: ballCounter })
            } else {
                setDisplayWicketType(false)
                setDisplayWicketTakenBy(false)
                setDisplayRunForStricker(false)
    ...
    const submitData = async (e) => {
        ...
        if (Object.keys(ErrorList).length === 0) {
            ...
            if (response?.data?.status) {
                ...
                if (inputData.ball_action === "RUN" && (inputData.striker_run === 1 || inputData.striker_run === 3 || inputData.striker_run === 5)) {
                ...
                if (inputData.ball_action === "WICKET") {
                    if (inputData.wicket_type === "RUNOUT") {
                        ...
                        const updatedArray = battingTeamPlayers.filter(item => item.playerdta._id !== inputData.strikerID)
    ...
    const fetchAllData = async () => {
        ...
        if (response && Object.keys(response.data.data).length > 0) {
            ...
            // }
            setInputData({ ...inputData, bollerID: groupsByOver[uniqueOvers.length - 1][uniqueOvers.length - 1].bollerID, ball_action: "", striker_run: 0, extra_run: 0, is_boundry: false, is_six: false, extra_type: "", wicket_type: "", wicket_tackers: [] });
            ...
            if (overChangeIndicator === 5) {
                ...
                setOverCounter(groupsByOver[uniqueOvers.length - 1][uniqueOvers.length - 1].over_number + 1)
            } else {
                setBallCounter(response?.data?.data.length + 1)
                setOverCounter(groupsByOver[uniqueOvers.length - 1][uniqueOvers.length - 1].over_number)
            }
            // setMatchOvers(groupsByOver)
        }
    }
                                                                                                            ...
                                                                                                            <option selected>Choose player...</option>
                                                                                                            {
                                                                                                                bowlingTeamPlayers
                                                                                                                    ...
                                                                                                                    .map((item, index) => {
                                                                                                                        return (
                                                                                                                            <>
                                                                                                                                <option value={item.playerdta?._id} key={index}
                                                                                                                                    selected={item.playerdta?._id == matchOvers[itemOver][0].bollerID ? true : false}
                                                                                                                                >{item.playerdta?.playerName}</option>
                                                                                                                            </>
                                                                                                                        )
                                                                                                                    })
                                                                                                            }
                                                                                                                    ...
                                                                                                                    <div class="col-md-2 no-padding">
                                                                                                                        <div class="form-floating _mb-3">
                                                                                                                            ...
                                                                                                                            >
                                                                                                                                ...
                                                                                                                                {
                                                                                                                                    battingTeamPlayers
                                                                                                                                        .filter(item => item.playerdta?._id !== ball.nonStrikerID)
                                                                                                                                        .map((item, index) => {
                                                                                                                                            return (
                                                                                                                                                <>
                                                                                                                                                    <option value={item.playerdta?._id} key={index}
                                                                                                                                                        selected={item.playerdta?._id == ball.strikerID ? true : false}
                                                                                                                                                    >{item.playerdta?.playerName}</option>
                                                                                                                                                </>
                                                                                                                                            )
                                                                                                                                        })
                                                                                                                            ...
                                                                                                                            <>
                                                                                                                                <div class="col-md-2 no-padding">
                                                                                                                                    <div class="form-floating _mb-3">
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            ball.wicket_tackers?.length > 0 && (
                                                                                                                                                <>

                                                                                                                                                    <ul class="list-group">
                                                                                                                                                        {
                                                                                                                                                            ball.wicket_tackers.map((item, index) => {
                                                                                                                                                                return (
                                                                                                                                                                    <>
                                                ...
                                                <h2 class="accordion-header" id={`heading`}>
                                                    <div class="accordion-button">
                                                        <div class="btn btn-primary mb-2" type="button" data-bs-toggle="collapse" data-bs-target={`#collapse`} aria-expanded="true" aria-controls={`collapse`}>
                                                            Over <span class="badge bg-white text-primary">{overCounter}.{ballCounter} </span>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-floating _mb-3">
                                                                <select class="form-select"
                                                                        ...
                                                                        bowlingTeamPlayers
                                                                            ...
                                                                            .map((item, index) => {
                                                                                return (
                                                                                    <>
                                                                                        <option value={item.playerdta?._id} key={index}
                                                                                            selected={item.playerdta?._id == inputData.bollerID ? true : false}
                                                                                        >{item.playerdta?.playerName}</option>
                                                                                    </>
                                                                                )
                                                                            })
                                                            ...
                                                            <div class="col-md-2 no-padding">
                                                                <div class="form-floating _mb-3">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        {
                                                                            battingTeamPlayers
                                                                                .filter(item => item.playerdta?._id !== inputData.nonStrikerID)
                                                                                .map((item, index) => {
                                                                                    return (
                                                                                        <>
                                                                                            <option value={item.playerdta?._id} key={index}
                                                                                                selected={item.playerdta?._id == inputData.strikerID ? true : false}
                                                                                            >{item.playerdta?.playerName}</option>
                                                                                        </>
                                                                                    )
                                                                                })
                                                            ...
                                                            <div class="col-md-2 no-padding">
                                                                <div class="form-floating _mb-3">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        {
                                                                            battingTeamPlayers
                                                                                .filter(item => item.playerdta?._id !== inputData.strikerID)
                                                                                .map((item, index) => {
                                                                                    return (
                                                                                        <>
                                                                                            <option value={item.playerdta?._id} key={index}
                                                                                                selected={item.playerdta?._id == inputData.nonStrikerID ? true : false}
                                                                                            >{item.playerdta?.playerName}</option>
                                                                                        </>
                                                                                    )
                                                                                })
