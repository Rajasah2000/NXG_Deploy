...
import { fetchAllBallByBall, fetchAllMatchTeamPlayers, fetchAllPlayer, updateBallByBall } from '../service/API'
    ...
    const postData = (e) => {
        ...
        if (name === "ball_action") {
            ...
            if (value === "RUN") {
                ...
                setDisplayExtraType(false)
                setDisplayExtraRun(false)
                setInputData({ ...inputData, ball_action: value, striker_run: 0, over_number: overCounter, ball_number: ballCounter })
        ...
        if (name === "wicket_type") {
            if (value === "BOLD") {
                // alert(inputData.bollerID)
                setDisplayWicketTakenBy(false)
                setDisplayRunForStricker(false)
                // setInputData({ ...inputData, strikerID: "" })
                                                ...
                                                <h2 class="accordion-header" id={`heading`}>
                                                    <div class="accordion-button">
                                                        <div class="btn btn-primary mb-2" type="button" data-bs-toggle="collapse" data-bs-target={`#collapse`} aria-expanded="true" aria-controls={`collapse`}>
                                                            Running Over <span class="badge bg-white text-primary">{overCounter}.{ballCounter} </span>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-floating _mb-3">
                                                                <select class="form-select"
