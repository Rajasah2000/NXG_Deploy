...
const ElementType = () => {
  ...
  const columns = [
    ...
    {
      name: <div style={{ fontSize: '14px', color: '#495057', fontWeight: 'bolder' }}>Element Type Name</div>,
  ...
  const AddProfession = async () => {
    if (hotelName) {
      ...
      setisupdate(false);
      toast.error('Element type name  is required');
    }
  };
  ...
  return (
    <>
      ...
      <main id="main" class="main">
        <div class="pagetitle">
          <h1>Element Type management</h1>
          <nav>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <Link to="/">Dashboard</Link>
              </li>
              <li class="breadcrumb-item">Element Type</li>
        ...
        <section class="section">
          <div class="row">
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Element type details</h5>
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-12">
                      <div class="form-floating">
                        ...
                        />
                        <label for="teamName">Element type name</label>
