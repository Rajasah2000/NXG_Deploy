...
const OverUpdateBallByBall = () => {
    ...
    const [inningsOvers, setInningsOvers] = useState(parseInt(overs))
    ...
    useEffect(() => {
        console.log("overChangeIndicator", overChangeIndicator, inputData.over_number, inputData.ball_number, inningsOvers);
        if (overChangeIndicator === 0 && inputData.ball_number > 1 && inningsOvers === inputData.over_number + 1) {
            ...
            //setBallCounter(1)
            inningsCompleted()
        } else if (overChangeIndicator === 0 && inputData.ball_number > 1 && inningsOvers === ((inputData.over_number + 1) / 2)) {
    ...
    const getOverChangeIndicator = async () => {
        ...
        if (response && Object.keys(response.data.data).length > 0) {
            ...
            console.log("L493", lastBall.over_number, lastBall.ball_number, inningsOvers, overChangeIndicator);

            if (lastBall.over_number >= inningsOvers && lastBall.ball_number > 0) {
                // console.log("L493", bowlingTeamPlayers)
                // const secondInningsBattingTeam = bowlingTeamPlayers
                // setBowlingTeamPlayers(allBattingPlayers)
                // console.log("L493", allBattingPlayers, bowlingTeamPlayers);
                // setBattingTeamPlayers(secondInningsBattingTeam)
            }
        }
    }
    ...
    const fetchAllData = async () => {
        ...
        if (response && Object.keys(response.data.data).length > 0) {
            ...
            console.log("groupsByOver", groupsByOver);
                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Over Details <span>BALL BY BALL</span><br /><span>{inningsOvers} overs match</span></h5>
                                                ...
                                                <h2 class="accordion-header" id={`heading`}>
                                                    <div class="accordion-button">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-floating _mb-3">
                                                                {
                                                                    ballCounter > 0 && overChangeIndicator > 0 ?
                                                                        <>
                                                                            <input
                                                                                type="text"
                                                                                class="form-control"
                                                                                disabled
                                                                                value={overCounter && matchOvers[overCounter][0]?.bollerName}
                                                                            />
                                                                        </> :
                                                                        <>
                                                                            <select class="form-select"
                                                                                                                    ...
                                                                                                                    <div class="col-md-2 no-padding">
                                                                                                                        <div class="form-floating _mb-3">
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                ...
                                                                                                                                class="form-control"
                                                                                                                                disabled
                                                                                                                                value={matchOvers[overCounter][0].strikerName}
                                                                                                                            />
                                                                                                                            <label for="strikerID">Stricker Batsman:</label>
                                                                                                                        </div>
                                                                                                                    </div>
